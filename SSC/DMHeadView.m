...
- (void)createMainView {
    ...
    _pre_resultY.frame    = CGRectMake(CGRectGetMaxX(line4.frame), Adaptive(0.5), Width, Adaptive(29));
    ...
    preLine.frame    = CGRectMake(CGRectGetMaxX(line4.frame),
    ...
    _mid_resultY.frame    = CGRectMake(CGRectGetMaxX(line7.frame), Adaptive(0.5),Width, Adaptive(29));
    ...
    midLine.frame    = CGRectMake(CGRectGetMaxX(line7.frame),
    ...
    _last_resultY.frame    = CGRectMake(CGRectGetMaxX(line10.frame), Adaptive(0.5),Width, Adaptive(29));
    ...
    lastLine.frame    = CGRectMake(CGRectGetMaxX(line10.frame),
