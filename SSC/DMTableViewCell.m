...
- (void)createMainView {
    ...
    // 期数
    timesNumberLabel = [[UILabel alloc] init];
    timesNumberLabel.frame    = CGRectMake(0, 0, Adaptive(48), Adaptive(60));
    timesNumberLabel.text     = @"20160912042";
    ...
    pre_result.frame    = CGRectMake(CGRectGetMaxX(line4.frame), Adaptive(0.5), Adaptive(37), Adaptive(59));
    ...
    UILabel *line5 = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(pre_result.frame),
                                                               0,
                                                               Adaptive(.5),
                                                               60)];
    ...
    mid_result.frame    = CGRectMake(CGRectGetMaxX(line7.frame), Adaptive(0.5), Adaptive(37), Adaptive(59));
    ...
    UILabel *line8 = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(mid_result.frame),
                                                               0,
                                                               Adaptive(.5),
                                                               60)];
    ...
    last_result.frame    = CGRectMake(CGRectGetMaxX(line10.frame), Adaptive(0.5), Adaptive(37), Adaptive(59));
    last_result.text     = @"Y";
